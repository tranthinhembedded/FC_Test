...
extern volatile uint32_t rc_channel_range_error_count;
extern volatile uint32_t rc_max_pending_bytes;
extern volatile uint32_t rc_raw_sw_arm;
extern volatile uint32_t rc_raw_sw_mode;
extern volatile uint32_t rc_raw_sw_poshold;
extern volatile uint32_t rc_switch_glitch_count;
extern volatile uint32_t rc_arm_switch_change_count;
extern volatile uint32_t rc_mode_switch_change_count;
extern volatile uint32_t rc_poshold_switch_change_count;
extern volatile uint32_t rc_failsafe_apply_count;
extern volatile uint8_t rc_arm_switch_candidate_count;
extern volatile uint8_t rc_mode_switch_candidate_count;
extern volatile uint8_t rc_poshold_switch_candidate_count;
